# Basic Job Management System

Simple Job listing website using following:

* [Yii 2](http://www.yiiframework.com/)
* bootstrap   

don't forget composer(for package management in php). 
...
```bash
$ composer create-project --prefer-dist --stability=dev yiisoft/yii2-app-basic <project-name>
```
